...
- 🗣️ **AI-Powered Guidance** – Get career recommendations powered by AI.  
- 📈 **Industry Insights** – Stay up to date with current job market trends.  
- 🧾 **Resume Suggestions** – Improve your resume with AI suggestions.  
...
- **Backend:** Next.js API Routes (Node.js-based)  
